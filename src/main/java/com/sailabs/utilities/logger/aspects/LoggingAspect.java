...
import com.sailabs.utilities.logger.Logger;
...
public class LoggingAspect {
	...
	@AfterThrowing(value = "@annotation(com.sailabs.utilities.logger.aspects.Loggable)", throwing = "throwable", argNames = "joinPoint, throwable")
